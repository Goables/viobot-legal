...
* Discord channel IDs
* Discord role IDs
* Message IDs related to bot logs or moderation records
* Moderator IDs associated with moderation actions
* Moderation action records, such as warnings, mutes, bans, unbans, nickname changes, role changes, and related reasons
...
* Restoring roles after mutes, voice mutes, or rejoins
